...
export function order2report(params: {
    ...
    let event: factory.event.IEvent<factory.eventType.ScreeningEvent> | undefined;
        ...
        (acceptedOffer) => {
            ...
            if (acceptedOffer.priceSpecification !== undefined) {
                switch (acceptedOffer.priceSpecification.typeOf) {
                    case factory.priceSpecificationType.UnitPriceSpecification:
                        const priceSpec
                    ...
                    case factory.priceSpecificationType.CompoundPriceSpecification:
                        const compoundPriceSpec
                            = <factory.compoundPriceSpecification.IPriceSpecification<factory.priceSpecificationType>>
                            acceptedOffer.priceSpecification;

                        const unitPriceSpec = compoundPriceSpec.priceComponent.find(
                            (component) => component.typeOf === factory.priceSpecificationType.UnitPriceSpecification
                        );
